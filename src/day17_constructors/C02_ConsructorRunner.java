...
public class C02_ConsructorRunner {
    public static void main(String[] args) {
         ...
         */
        System.out.println(obje.str); //Constructor
        obje.number=20;
        obje.notStaticMethod(); //C01 notstatic  method is run
    }
    }
