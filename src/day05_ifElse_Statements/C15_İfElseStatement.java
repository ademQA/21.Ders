...
public class C15_İfElseStatement {
    public static void main(String[] args) {
        ...
        if ((gender != 'F' && gender != 'M') || age<10 || age>80){
            System.out.println("INCORRECT ENTRY");
        }else if (gender == 'F' && age>=60){
            System.out.println("Woman over 60, can retire");
        } else if (gender == 'F' && age<60) {
            System.out.println("The woman should work until the age of 60, you have to work more" +(60-age)+  "years");
        } else if (gender=='M' && age>=65) {
            System.out.println("Man over 65 ,can retire");
        }else if (gender=='M' && age<65){
            System.out.println("Man should work until the age of 65, you have to work more "+(65-age)+ " years");
        }
